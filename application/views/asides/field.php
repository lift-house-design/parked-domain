<?php
	...
	$slug=!empty($params['slug']) ? $params['slug'] : FALSE;
	unset($params['slug']);
...
<div class="field<?php echo ( $required ? ' required' : '' ) ?>">
	...
	<?php switch($type):
		...
		*/
			case 'captcha': ?>
				<div class="captcha-image"><img src="<?php echo site_url($slug) ?>" /></div>
				Enter the letters/numbers you see in the image below.<br />
				<?php echo call_user_func('form_input',$params) ?>
